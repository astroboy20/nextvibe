        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            <Input
              ...
              value={
                dateField.value
                  ? `${dateField.value.getFullYear()}-${String(
                      dateField.value.getMonth() + 1
                    ).padStart(2, "0")}-${String(
...
export default function StepThree() {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      rsvpStartDate: data.rsvpStartDateTime
        ? new Date(data.rsvpStartDateTime as any)
        : new Date(),
      rsvpStartTime: data.rsvpStartDateTime
        ? new Date(data.rsvpStartDateTime as any)
        : createDefaultTime(9),
      rsvpEndDate: data.rsvpEndDateTime
        ? new Date(data.rsvpEndDateTime as any)
        : undefined,
      rsvpEndTime: data.rsvpEndDateTime
        ? new Date(data.rsvpEndDateTime as any)
        : createDefaultTime(23, 59),
    },
  });
  ...
  const handleAutomatedRemindersChange = (
    reminders: any[] | AutomatedReminder[]
  ) => {
      ...
      >
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-gray-500">
            Configure when attendees can RSVP to your event. This helps you
            track attendance and send targeted communications.
          </p>
          {data.startDateTime && (
        ...
        <div className="flex items-start gap-2.5 rounded-xl bg-blue-50 border border-blue-100 p-4">
          ...
          <p className="text-sm text-blue-700 leading-relaxed">
            <strong>Tip:</strong> RSVP should close at least a few hours before
            your event starts to give you time to prepare based on confirmed
            attendance.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-gray-500">
            Customize your RSVP confirmation message and set up automated
        ...
        <Tabs defaultValue="invite">
          ...
          <TabsContent value="invite" className="border rounded-xl">
          ...
          <TabsContent value="reminders" className="border rounded-xl">
            <div className="w-full!  p-0!">
              <div className="w-full!">
