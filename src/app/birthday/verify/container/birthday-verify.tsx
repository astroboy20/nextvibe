          ...
          <div className="flex flex-col items-center gap-5 py-6 text-center">
            ...
            <div>
              ...
              <p className="mt-1.5 text-xs leading-relaxed text-muted-foreground">
                ...
                check your email — your confirmation and redemption code will be
                there.
              </p>
            </div>
        ...
        {status === "completed" && (
          <div className="flex flex-col items-center gap-5 text-center">
            ...
            <div>
              ...
              <p className="mt-1.5 text-xs leading-relaxed text-muted-foreground">
                Your deposit is confirmed. Save the redemption code below —
                you&apos;ll use it to publish your event for free on NextVibe.
              </p>
            </div>
