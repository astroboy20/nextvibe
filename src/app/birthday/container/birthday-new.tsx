...
const features = [
  ...
  },
  {
    ...
    brand: "Secured Spot",
    desc: "Lock the promotional price for this birthday package, per the offer terms.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "Guests are based on pricing tier. Each guest can add up to 20 postcards per event so the gallery stays browsable.",
  },
  {
...
export default function BirthdayFunnel() {
  ...
  return (
    <div className="min-h-screen bg-background pb-24 md:pb-0">
      ...
      <section
        ref={heroRef}
        className="border-b border-border/50 py-12 md:py-20 lg:py-28"
      >
            ...
            >
              ...
              <div className="grid grid-cols-4 gap-2">
                {[
                  ...
                  <div
                    key={t.l}
                    className="rounded-lg border border-border bg-secondary/40 py-2.5 text-center"
                  >
              ...
              <p className="mt-2 text-center text-xs text-muted-foreground">
                ...
                of {SPOTS_TOTAL} spots remaining
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto max-w-3xl px-4">
          ...
          >
            <div className="relative aspect-video w-full bg-black">
              ...
              <iframe
                className={`absolute inset-0 size-full rounded-xl transition-opacity duration-300 ${
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {testimonials.map((t, i) => (
              ...
              >
                ...
                <p className="flex-1 text-xs italic leading-relaxed">
                  &quot;{t.quote}&quot;
                </p>
      ...
      <section
        id="funnel"
        className="border-y border-border/50 bg-secondary/20 py-12 md:py-20"
      >
            ...
            {step === 3 && (
              <form onSubmit={submitDetails} className="space-y-5">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="funnel-name" className="text-xs">
                    Your name
                  </Label>
                  <Input
                    id="funnel-name"
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="funnel-email" className="text-xs">
                    Email
                  </Label>
                  <Input
                    id="funnel-email"
            ...
            {step === 4 && (
              <form onSubmit={submitDate} className="space-y-5">
                <div>
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    We&apos;ll time your setup reminders and event-day support
                    around this date.
                  </p>
                </div>
                <div className="space-y-1.5">
              ...
              <div className="space-y-5">
                ...
                >
                  {submitting ? (
                    ...
                    <>
                      Pay{" "}
                      {tierQuote ? formatNaira(tierQuote.amountDue) : "deposit"}{" "}
                      &amp; secure my spot
                    </>
                  )}
                </Button>
        ...
        <div className="container mx-auto max-w-2xl px-4">
          ...
          >
            ...
            <p className="text-xs text-primary-foreground/80 md:text-sm">
              Lock your founder deposit for your next celebration. Setup takes 4
              minutes.
            </p>
            {!isFull && (
              <Button
