...
const reasons = [
  {
    ...
    body: 'Lost wedding photos. Dead WhatsApp groups. Expired Drive links. We built NextVibe because we lost our own send-off party photos — every single one. Backing us means saying "never again" to lost memories.',
  },
  {
    icon: Tag,
    title: "An Unbeatable Deal (That Won't Last)",
    body: "Every tier gives you 3 bundles for the price of 1. Use them yourself, gift them, save them. This pricing disappears the moment the campaign ends.",
  },
  {
    icon: Rocket,
    title: "Help Build the Future of Events",
    body: "1,100+ users. 1,200+ postcards. 3,400+ games played in 5 weeks. Your backing funds native iOS & Android apps, offline postcard queues, push notifications, and African + US expansion.",
  },
  {
    icon: Users,
    title: "Become Part of Something Bigger",
    body: "Backers aren't customers — they're co-creators. Hall of Fame listing, Founders Wall photo, private WhatsApp with the team, and first say in what we build next.",
  },
  {
    icon: CheckCircle2,
    title: "A Product That Already Works",
    body: "We're not asking you to fund an idea. Successful pilots at UNILAG Hall Weeks (Makama, Moremi, Jaja). 5,200+ postcard & game impressions. Proven, loved, scaling.",
  },
  {
    icon: Clock,
    title: "Get In Early. Really Early.",
    body: "When NextVibe launches fully, lifetime access won't be $100 — it'll be $500+. Backing now locks in your rate forever.",
  },
];
      ...
      >
        ...
        <h2 className="mt-6 font-display text-3xl sm:text-5xl font-bold leading-tight">
          ...
          <span className="text-gradient">
            We&apos;re building their forever home.
          </span>
        </h2>
        <p className="mt-4 text-lg text-muted-foreground">
          Backing NextVibe isn&apos;t just a great deal on event tools —
          it&apos;s joining a movement to fix something that&apos;s been broken
          for too long.
        </p>
      </motion.div>
