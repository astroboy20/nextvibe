    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1.5">
          <Label className="text-xs text-muted-foreground">Starts At <span className="text-destructive">*</span></Label>
          <Input
            type="datetime-local"
            value={startsAt}
            ...
            className="h-10"
          />
          {maxStartsAt && <p className="text-[11px] text-muted-foreground">Must be before the event starts</p>}
        </div>
        <div className="space-y-1.5">
          <Label className="text-xs text-muted-foreground flex items-center gap-1">
            Ends At <Lock className="h-3 w-3" />
          </Label>
          <Input
            type="datetime-local"
            value={gameEndsAt}
          ...
          />
          <p className="text-[11px] text-muted-foreground">Auto-set: 1 min before event</p>
        </div>
      </div>
    </div>
